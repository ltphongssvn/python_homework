...
class SQLQueryExplorer:
    ...
    def _custom_query_mode(self):
        ...
        print(
            "Enter your SQL query (type 'exit' to quit, \\h for help, end with ';')"
        )
        ...
        while True:
            ...
            # FIX: Add PRAGMA to the list of allowed statement types.
            if not (
    ...
    def _show_query_help(self):
        ...
        print("\nExample: Inspect a table schema")
        print("  PRAGMA table_info(team_standings);")
