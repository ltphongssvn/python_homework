...
class Config:
    ...
    def get_database_path(cls):
        ...
        raise FileNotFoundError(
            f"Could not find '{cls.DATABASE_NAME}' in any of these locations:\n{searched_paths}\n"
                ...
                dbc.Alert(
                    [
                        ...
                        html.Ul(
                            [
                                html.Li(
                                    f"Database file exists at: C:\\Users\\LENOVO\\python_homework\\assignment14\\{Config.DATABASE_NAME}"
                                ),
                                html.Li(
                                    "The database contains tables: team_standings, player_stats, pitcher_stats"
                                ),
                                html.Li(
